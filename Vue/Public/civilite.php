                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 mt-3 col">
                            ...
                            <input pattern = "(^[a-z]{1,}[a-z0-9._]{1,}@[a-z]{1,}\.[a-z]{2,4}$)" title="xxxxx@yyyyy.zzz" type="mail" class="form-control" id="mail" placeholder="adresse mail courante" name="mail">
                        </div>
                        <div class="mb-3 mt-3 col">
                            <label for="mailPro" class="form-label">Courriel professionnel :</label>
                            <input pattern = "(^[a-z]{1,}[a-z0-9._]{1,}@[a-z]{1,}\.[a-z]{2,4}$)" title="xxxxx@yyyyy.zzz" type="mail" class="form-control" id="mailPro" placeholder="Exemple : jean.dupond@laposte.net" name="mailPro">
                        </div>
                    </div>
